...
<body>
	<%
		...
		session.setAttribute("s_name4", "저는 세션에 저장된 네 번째 값이에요. ^_^ ");
		session.setAttribute("s_name5", "저는 세션에 저장된 다섯 번째 값이에요. ^_^ ");
		session.setAttribute("s_name6", "저는 세션에 저장된 여섯 번째 값이에요. ^_^ ");
